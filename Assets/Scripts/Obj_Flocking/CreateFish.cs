...
public class CreateFish : MonoBehaviour
{
  ...
  //  public GameObject specialPoint;
    ...
    public static GameObject[] FishClone = new GameObject[30];
    ...
    void Start()
    {
        ...
        {/*######## 생성될 물고기 개수입니다. 열대어 1종류당 30개씩 총 90개가 생성됩니다.
           조정하셔야 하는 부분입니다.########*/
            ...
            Vector3 for_random_minus = camMarked_pos - new Vector3(range_, 3, range_);
            Vector3 for_random_plus = camMarked_pos + new Vector3(range_, 3, range_);
